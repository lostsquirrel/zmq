...
public class RouterBrokerReqWorkerDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			...
			broker.recvStr(Charset.defaultCharset()); // Envelope delimiter
			broker.recvStr(Charset.defaultCharset()); // Response from worker
			broker.sendMore("");
